...
- Median: **`r format(median_steps, big.mark=",", scientific=FALSE)`** steps per day  
- Mean: **`r format(mean_steps, big.mark=",", scientific=FALSE)`** steps per day  
...
There are **`r format(sum(is.na(activity$steps)), big.mark=",", scientific=FALSE)`** "NA" values in the steps column.   
...
*Mean:*  
Non-imputed mean = `r format(mean_steps, big.mark=",", scientific=FALSE)`  
Imputed mean = `r format(mean_complete, big.mark=",", scientific=FALSE)`  
Difference = **`r format(abs(mean_complete - mean_steps), big.mark=",", scientific=FALSE)`** steps.  
  
*Median:*  
Non-imputed median = `r format(median_steps, big.mark=",", scientific=FALSE)`  
Imputed median = `r format(median_complete, big.mark=",", scientific=FALSE)`  
Difference = **`r format(abs(median_complete - median_steps), big.mark=",", scientific=FALSE)`** steps.  
